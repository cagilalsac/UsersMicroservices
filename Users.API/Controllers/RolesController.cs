    ...
    public class RolesController : ControllerBase
    {
            ...
            catch (Exception exception)
            {
                ...
                return StatusCode(StatusCodes.Status500InternalServerError, 
                    new CommandResponse(false, 
                        "An exception occured during RolesGet.")); 
            }
        }
        ...
        public async Task<IActionResult> Get(int id)
        {
            ...
            catch (Exception exception)
            {
                ...
                return StatusCode(StatusCodes.Status500InternalServerError, 
                    new CommandResponse(false, 
                        "An exception occured during RolesGetById.")); 
            }
        }
        ...
        public async Task<IActionResult> Post(RoleAddRequest request)
        {
            ...
            catch (Exception exception)
            {
                ...
                return StatusCode(StatusCodes.Status500InternalServerError, 
                    new CommandResponse(false, 
                        "An exception occured during RolesPost.")); 
            }
        }
        ...
        public async Task<IActionResult> Put(RoleUpdateRequest request)
        {
            ...
            catch (Exception exception)
            {
                ...
                return StatusCode(StatusCodes.Status500InternalServerError, 
                    new CommandResponse(false, 
                        "An exception occured during RolesPut.")); 
            }
        }
        ...
        public async Task<IActionResult> Delete(int id)
        {
            ...
            catch (Exception exception)
            {
                ...
                return StatusCode(StatusCodes.Status500InternalServerError, 
                    new CommandResponse(false, 
                        "An exception occured during RolesDelete.")); 
            }
        }
	}
}
